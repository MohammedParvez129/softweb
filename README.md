...
<html>
  <head>
    ...
    <title>PARZIVAL DEVELOPEMENT COMPANY</title>
    <style type="text/css">
      * {
        margin: 0;
        padding: 0;
      ...
      .navbar li:hover {
        ...
        cursor: pointer;
        border-radius: 30px;
        background: rgb(234, 12, 186);
        color: #081b29;
        box-shadow: 0 0 20px rgb(225, 18, 197);
      }
      .content {
        position: absolute;
        top: 50%;
  ...
  <body>
    <div class="banner">
      <br />
      <div class="navbar">
        <h1 class="logo">PAR<span>ZIV</span>D<span>EVELOPED</span></h1>
        <ul>
    ...
    <footer>
      <center>DESIGNED AND DEVELOPED BY MOHAMMED PARVEZ (212223040113)</center>
    </footer>
  </body>
</html>
    ...
    <style type="text/css">
      * {
      ...
      footer {
        ...
        color: #081b29;
        box-shadow: 0 0 20px rgb(255, 0, 251);
      }
      .space{
        padding-left: 30px;
      }
    ...
    <div class="banner">
      ...
      <div class="box">
        ...
        <div class="box-2">
          ...
          <p>
            <span>Address</span> : 9th Floor, Tower 5, fgdg
            Building No.58,fdgd CREATE CITY Phase-I DELHI HR IN 355852
          </p>
          <p><span>Email</span> : parzivdeveloped.official@gmail.com</p>
...
## OUTPUT:
home.html
![alt text](<Screenshot 2024-04-26 203414.png>)

products.html
![alt text](<Screenshot 2024-04-26 203610.png>)

council.html
![alt text](<Screenshot 2024-04-26 203620.png>)

contact_us.html

![alt text](<Screenshot 2024-04-26 203629.png>)
